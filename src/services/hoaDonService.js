...
const {crawlHoaDon} = require('../modules/crawlHoaDon'); // Import hàm lấy điểm

// Khởi tạo browser và thực hiện các thao tác
async function crawlXemHoaDon(username, password) {
  let broswer;
  try{
    ...
    if(isLogin) {
      ...
      const data = await crawlHoaDon(page); // Proceed to crawl if login succeeds
      return data;
    } else{
