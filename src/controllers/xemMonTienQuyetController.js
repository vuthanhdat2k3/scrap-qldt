const {crawlMonTienQuyet} = require('../services/monTienQuyetService'); // Đảm bảo bạn đã xuất hàm crawl từ file crawlXemHocPhi.js

// Controller để crawl dữ liệu học phí
const xemMonTienQuyetController = {
  async crawlData(req, res) {
    try {
      const browser = await crawlMonTienQuyet(); // Chạy hàm crawlXemHocPhi
...
module.exports = xemMonTienQuyetController;
