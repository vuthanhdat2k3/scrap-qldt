...
const { login } = require('./src/modules/loginModule'); // Import hàm đăng nhập
const crawlCTDT = require("./src/modules/crawlCTDT");  // Import hàm lấy chương trình đào tạo
const crawlMTQuyet = require("./src/modules/crawlMTQuyet");  // Import hàm lấy môn tiên quyết
const crawlDKMH = require("./src/modules/crawlDKMH"); // Import hàm lấy danh sách môn học dang ký
const crawlXemHocPhi = require("./src/modules/crawlXemHocPhi");
const crawlHoaDon = require("./src/modules/crawlHoaDon");
const { extractAllTimetable } = require('./src/modules/crawlTKBTuan'); // Import hàm lấy thời khóa biểu
const { extractTKBHK } = require('./src/modules/crawlTKBHK'); // Import hàm lấy thời khóa biểu học kỳ
const { extractLichThi } = require('./src/modules/crawlLichThi'); // Import hàm lấy lịch thi
const { getGrades } = require('./src/modules/crawlDiem'); // Import hàm lấy điểm
